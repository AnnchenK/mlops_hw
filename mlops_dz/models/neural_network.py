...
class NeuralNetworkParams(ModelParams):
    ...
    layers: PositiveInt = Field(description="number of hidden layers")
    layer_size: PositiveInt = Field(description="size of the hidden layers")
...
class NeuralNetwork(Model):
    ...
    def __init__(self, params: NeuralNetworkParams) -> None:
        ...
        self._model = MLPRegressor(
            hidden_layer_sizes=(self._params.layer_size,) * self._params.layers,
